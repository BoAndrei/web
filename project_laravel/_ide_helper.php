...
namespace Illuminate\Support\Facades {
    ...
    class Request {
         ...
         * 
         * Suppose that an editproducts.blade.php file instantiates this request object:
         * 
         *  * http://localhost/editproducts.blade.php         returns an empty string
         *  * http://localhost/editproducts.blade.php/page    returns an empty string
         *  * http://localhost/web/editproducts.blade.php     returns '/web'
         *  * http://localhost/we%20b/editproducts.blade.php  returns '/we%20b'
         *
         * @return string The raw path (i.e. not urldecoded)
         * @static 
         */
         ...
         * script filename (e.g. editproducts.blade.php) if one exists.
         *
