...
class UrlGenerator implements UrlGeneratorContract
{
    ...
    public function asset($path, $secure = null)
    {
        ...
        // Once we get the root URL, we will check to see if it contains an editproducts.blade.php
    ...
    /**
     * Remove the editproducts.blade.php file from a path.
     *
     * @param  string  $root
     * @return string
     */
