...
class RequestTest extends TestCase
{
    ...
    public function testGetUri()
    {
        ...
        $server['REQUEST_URI'] = '/editproducts.blade.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/editproducts.blade.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/editproducts.blade.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/editproducts.blade.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/editproducts.blade.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/editproducts.blade.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/editproducts.blade.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide editproducts.blade.php)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ editproducts.blade.php [QSA,L]
        ...
        $server['SCRIPT_NAME'] = '/editproducts.blade.php';
        $server['PHP_SELF'] = '/editproducts.blade.php';
        $server['SCRIPT_FILENAME'] = '/some/where/editproducts.blade.php';
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/editproducts.blade.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/editproducts.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/editproducts.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/editproducts.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/editproducts.blade.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/editproducts.blade.php';
        $server['ORIG_SCRIPT_NAME'] = '/editproducts.blade.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                ...
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/fruit/editproducts.blade.php',
                    'SCRIPT_NAME' => '/fruit/editproducts.blade.php',
                    'PHP_SELF' => '/fruit/editproducts.blade.php',
                ),
                '/fruit',
            ...
            array(
                '/fruit/strawberry/1234index.php/blah',
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/editproducts.blade.php',
                    'SCRIPT_NAME' => '/editproducts.blade.php',
                    'PHP_SELF' => '/editproducts.blade.php',
                ),
                '',
                '/fruit/strawberry/1234index.php/blah',
            ),
