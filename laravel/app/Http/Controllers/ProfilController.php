...
class ProfilController extends Controller {
		...
		public function mesaje()
		{
			...
			if(Auth::check())
			{
				...
				$mesaje = DB::table('mesaje')->where('destinatar_id',Auth::user()->user_id)->orWhere('expeditor_id',Auth::user()->user_id)->join('users','user_id','=','mesaje.expeditor_id')->orderBy('citit', 'asc')->orderBy('data_mesajului', 'desc')->get();
